...
class RuleItemInline(admin.TabularInline): model=RuleItem; extra=0
...
class RuleItemAdmin(admin.ModelAdmin): list_display=('code','title','section','punishment','sort_order','is_public'); search_fields=('code','title','body','punishment'); list_filter=('section','is_public')
