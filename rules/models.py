...
class RuleItem(models.Model):
    section=models.ForeignKey(RuleSection,on_delete=models.CASCADE,related_name='items'); code=models.CharField('Номер/код',max_length=32,blank=True); title=models.CharField('Заголовок',max_length=255); body=models.TextField('Текст правила'); punishment=models.CharField('Наказание',max_length=255,blank=True); sort_order=models.PositiveIntegerField('Сортировка',default=100); is_public=models.BooleanField('Показывать',default=True)
